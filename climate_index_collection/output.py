...
def compute_index(data_path="../data/test_data/", data_source_name="FOCI", index_function=southern_annular_mode):
...
def concat_indices(data_path="../data/test_data/", data_source_names=None, index_functions=None):
...
def create_csv(data_path="../data/test_data/", file_name='output.csv', data_source_names=None, index_functions=None):
    ...
    """
    df = concat_indices(data_path=data_path, data_source_names=data_source_names, index_functions=index_functions)
